...
public class FucntionInClasses {
    public static void main(String[] args) {
        ...
        Triangle triangle = new Triangle(); // made an object of triangle class constructor made an object
        Flag flag = new Flag(); // made an object of flag class and also constructor made an object


        int exit,condition,value,number;
        boolean again = true;
        while(again){
        ...
        int choice = sc.nextInt();
            ...
            System.out.println("If you want to exit this program press 3 else press any number to continue");
            number = sc.nextInt();
            if(number == 3){
                again = false;
            }
